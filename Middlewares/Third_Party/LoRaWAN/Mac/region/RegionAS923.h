 ...
 */
#define AS923_TX_MAX_DATARATE                       DR_3
 ...
 * Maximal datarate that can be used by the node
 */
#define AS923_RX_MAX_DATARATE                       DR_3
 ...
 */
#define AS923_LC1                                   { 923200000, 0, { ( ( DR_3 << 4 ) | DR_0 ) }, 0 }

/*!
 * LoRaMac default channel 2
 * Channel = { Frequency [Hz], RX1 Frequency [Hz], { ( ( DrMax << 4 ) | DrMin ) }, Band }
 */
#define AS923_LC2                                   { 923400000, 0, { ( ( DR_3 << 4 ) | DR_0 ) }, 0 }
