...
CPP_SRCS += \
../Core/Application/lorawan/lorawan.cpp 

OBJS += \
./Core/Application/lorawan/lorawan.o 

CPP_DEPS += \
./Core/Application/lorawan/lorawan.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Application/lorawan/%.o Core/Application/lorawan/%.su Core/Application/lorawan/%.cyclo: ../Core/Application/lorawan/%.cpp Core/Application/lorawan/subdir.mk
...
clean: clean-Core-2f-Application-2f-lorawan

clean-Core-2f-Application-2f-lorawan:
	-$(RM) ./Core/Application/lorawan/lorawan.cyclo ./Core/Application/lorawan/lorawan.d ./Core/Application/lorawan/lorawan.o ./Core/Application/lorawan/lorawan.su

.PHONY: clean-Core-2f-Application-2f-lorawan
