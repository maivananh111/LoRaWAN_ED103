...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, LED_ACT_Pin|MB_DE_Pin|MB_RE_Pin|SENSOR_PWR_Pin
                          |MB_PWR_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PB3 PB4 PB5 PB0
                           PB12 */
  ...
  /*Configure GPIO pins : PAPin PAPin PAPin PAPin
                           PAPin PAPin */
  GPIO_InitStruct.Pin = LED_ACT_Pin|MB_DE_Pin|MB_RE_Pin|SENSOR_PWR_Pin
                          |MB_PWR_Pin|WF_PWR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = CHMOD_BTN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(CHMOD_BTN_GPIO_Port, &GPIO_InitStruct);
