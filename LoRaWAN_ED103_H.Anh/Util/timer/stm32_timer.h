...
typedef struct TimerEvent_s {
	uint64_t Timestamp; /*!<Expiring timer value in ticks from TimerContext */
	uint64_t ReloadValue; /*!<Reload Value when Timer is restarted            */
...
typedef struct {
	...
	UTIL_TIMER_Status_t (*StartTimerEvt)(uint64_t timeout); /*!< Start the low layer timer */
	UTIL_TIMER_Status_t (*StopTimerEvt)(void); /*!< Stop the low layer timer */

	uint64_t (*SetTimerContext)(void); /*!< Set the timer context */
	uint64_t (*GetTimerContext)(void); /*!< Get the timer context */

	uint64_t (*GetTimerElapsedTime)(void); /*!< Get elapsed time */
	uint64_t (*GetTimerValue)(void); /*!< Get timer value */
	uint64_t (*GetMinimumTimeout)(void); /*!< Get Minimum timeout */

	uint64_t (*ms2Tick)(uint64_t timeMicroSec); /*!< convert ms to tick */
	uint64_t (*Tick2ms)(uint64_t tick); /*!< convert tick into ms */
} UTIL_TIMER_Driver_s;

/**
  * @brief Timer value on 32 bits
  */
typedef uint64_t UTIL_TIMER_Time_t;
/**
  *  @}
  */
...
/**
  ...
  * @retval Status based on @ref UTIL_TIMER_Status_t
  */
UTIL_TIMER_Status_t UTIL_TIMER_Create( UTIL_TIMER_Object_t *TimerObject, uint64_t PeriodValue, UTIL_TIMER_Mode_t Mode, void ( *Callback )( void *) , void *Argument);
...
/**
  ...
  * @retval Status based on @ref UTIL_TIMER_Status_t
  */
UTIL_TIMER_Status_t UTIL_TIMER_StartWithPeriod( UTIL_TIMER_Object_t *TimerObject, uint64_t PeriodValue);
...
/**
  ...
  * @retval Status based on @ref UTIL_TIMER_Status_t
  */
UTIL_TIMER_Status_t UTIL_TIMER_SetPeriod(UTIL_TIMER_Object_t *TimerObject, uint64_t NewPeriodValue);
 ...
 * @retval Status based on @ref UTIL_TIMER_Status_t
 */
UTIL_TIMER_Status_t UTIL_TIMER_GetRemainingTime(UTIL_TIMER_Object_t *TimerObject, uint64_t *Time);
...
/**
  ...
  */
uint64_t UTIL_TIMER_GetFirstRemainingTime(void);
