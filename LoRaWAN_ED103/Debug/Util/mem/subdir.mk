...
C_SRCS += \
../Util/mem/stm32_mem.c 

OBJS += \
./Util/mem/stm32_mem.o 

C_DEPS += \
./Util/mem/stm32_mem.d 


# Each subdirectory must supply rules for building sources it contributes
Util/mem/%.o Util/mem/%.su Util/mem/%.cyclo: ../Util/mem/%.c Util/mem/subdir.mk
...
clean: clean-Util-2f-mem

clean-Util-2f-mem:
	-$(RM) ./Util/mem/stm32_mem.cyclo ./Util/mem/stm32_mem.d ./Util/mem/stm32_mem.o ./Util/mem/stm32_mem.su

.PHONY: clean-Util-2f-mem
