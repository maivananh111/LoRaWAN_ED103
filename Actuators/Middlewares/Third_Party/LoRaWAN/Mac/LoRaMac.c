...
const char *LoRaMacSrvCmdStrings[] = {
    [0x01] = "RESET_CONF",
    [0x02] = "LINK_CHECK_ANS",
    [0x03] = "LINK_ADR_REQ",
    [0x04] = "DUTY_CYCLE_REQ",
    [0x05] = "RX_PARAM_SETUP_REQ",
    [0x06] = "DEV_STATUS_REQ",
    [0x07] = "NEW_CHANNEL_REQ",
    [0x08] = "RX_TIMING_SETUP_REQ",
    [0x09] = "TX_PARAM_SETUP_REQ",
    [0x0A] = "DL_CHANNEL_REQ",
#if (defined( LORAMAC_VERSION ) && ( LORAMAC_VERSION == 0x01010100 ))
    [0x0B] = "REKEY_CONF",
    [0x0C] = "ADR_PARAM_SETUP_REQ",
#endif /* LORAMAC_VERSION */
    [0x0D] = "DEVICE_TIME_ANS",
#if (defined( LORAMAC_VERSION ) && ( LORAMAC_VERSION == 0x01010100 ))
    [0x0E] = "FORCE_REJOIN_REQ",
    [0x0F] = "REJOIN_PARAM_REQ",
#endif /* LORAMAC_VERSION */
    [0x10] = "PING_SLOT_INFO_ANS",
    [0x11] = "PING_SLOT_CHANNEL_REQ",
    [0x12] = "BEACON_TIMING_ANS",
    [0x13] = "BEACON_FREQ_REQ",
    [0x15] = "BEACON_SETTINGS_NOTICE",
#if (defined( LORAMAC_VERSION ) && ( LORAMAC_VERSION == 0x01010100 ))
    [0x20] = "DEVICE_MODE_CONF",
#endif /* LORAMAC_VERSION */
};
